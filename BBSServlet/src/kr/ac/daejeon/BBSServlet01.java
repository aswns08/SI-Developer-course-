...
@WebServlet(urlPatterns="*.daejeon",
			initParams={
			@WebInitParam(name="bbs_properties", value="C:/Users/Minjun/git/SI-Developer-course-/BBSServlet/WebContent/bbs.properties")
			// 복수개 사용시
			//,@WebInitParam(name="bbs_properties", value="D:/workspace_EE/BBSServlet/WebContent/bbs.properties")
			})
@MultipartConfig(location="d:/temp", maxFileSize=-1, maxRequestSize=-1, fileSizeThreshold=1024)
public class BBSServlet01 extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		...
		System.out.println("BBSServlet01요청입니다");
