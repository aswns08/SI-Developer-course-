...
public class Bill extends JFrame implements ActionListener{
	...
	public void order_Bill() {
		...
		System.out.println("ArrayList의 size" +MainMenu.orderMenu.size());
		
		for(int i=0 ; i<MainMenu.orderMenu.size() ; i++) {
			System.out.println(MainMenu.orderMenu.get(i));
			
			switch(MainMenu.orderMenu.get(i)) {
			case "chicken" :
