...
public class ChatClient extends JFrame implements Runnable, ActionListener{
	...
	public ChatClient(String tableNumber, String servAddr, int servPort) throws IOException{
	...
	public void initNetwork() throws IOException{
		...
		this.sendMessage("[" + tableNumber + "]:님이 입장했습니다.");
	}
	
	public void actionPerformed(ActionEvent e){
		String msg = tf1.getText();
		if(!msg.equals("")){
			this.sendMessage("[" + tableNumber + "]:" + msg);
			tf1.setText("");
		}
	}
	public void run(){
	...
	public void stop(){
		this.sendMessage("[" + tableNumber + "]:님이 퇴장합니다.");
		this.flag = true;
	}
